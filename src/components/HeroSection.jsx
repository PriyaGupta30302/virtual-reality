...
const HeroSection = () => {
    return (
        <div className="flex flex-col items-center mt-6 lg:mt-20">
            ...
            <p className="mt-10 text-lg tex-center text-neutral-500 max-w-4xl">
            ...
            <div className="flex justify-center my-10">
                <a href="#" className="bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md hover:scale-110">
                    Start for free
                </a>
                <a href="#" className="py-3 px-4 mx-3 rounded-md border hover:scale-110" >
                    Documentation
                </a>
            </div>
